...
public class EmergenzaServiceTest {
    ...
    @Before
    public void setup() {
        CentroTrasfusione centroTrasfusione = new CentroTrasfusione("sede@avis.it", "123123", "centroTrasfusione",
                "Marche", "Macerata", "Morrovalle");
        ...
        List<Emergenza> listEmergenza = new ArrayList<>();
        listEmergenza.add(emergenza);
        Mockito.when(emergenzaRepository.findByIdCentroTrasfusione(centroTrasfusione)).thenReturn(listEmergenza);
        List<CentroTrasfusione> listCentro = new ArrayList<>();
        listCentro.add(centroTrasfusione);
        Mockito.when(centroTrasfusioneRepository.findAll()).thenReturn(listCentro);
        List<Emergenza> listEmerg = new ArrayList<>();
        listEmerg.add(emergenza);
