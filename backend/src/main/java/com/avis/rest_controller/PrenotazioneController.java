...
public class PrenotazioneController {
    ...
    /*
     * @PostMapping("/public/prenota") public Optional<Prenotazione>
     * getDateLibere(@RequestBody String comune){ //controlla token return
     * null;//prenotazioniService.getDateLibere(comune); }
     */
    ...
    public boolean prenotaData(@RequestBody PrenotazioneDto prenotazioneDto) {
        // con il token mi creo un donatore, dto non serve
