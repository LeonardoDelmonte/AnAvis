...
public class SedeAvis extends Utente {
    ...
    public SedeAvis(@NotNull String email, @NotNull String password, @NotNull String ruolo, @NotNull String regione,
            @NotNull String provincia, @NotNull String comune) {
